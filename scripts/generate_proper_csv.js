...
// Function to generate proper CSV
function generateProperCSV() {
  console.log('🔧 Generating proper CSV format...');
  
  try {
    const inputPath = 'combined_events_all_updated.csv';
    ...
    // Write the proper CSV
    fs.writeFileSync(outputPath, outputLines.join('\n'), 'utf8');
    console.log(`✅ Proper CSV saved to: ${outputPath}`);
    ...
    console.error('❌ Error generating proper CSV:', error);
    throw error;
  }
}
...
module.exports = { generateProperCSV }; 